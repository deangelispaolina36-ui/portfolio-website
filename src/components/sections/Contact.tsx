            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <a
                  ...
                  className="contact-card-enhanced group block p-6"
                >
                  <div className="flex items-center gap-5">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-500/15 to-pink-500/15 flex items-center justify-center border border-purple-500/20 group-hover:border-purple-500/40 transition-all duration-300 group-hover:scale-110">
                    ...
                    <Send className="w-5 h-5 text-gray-600 group-hover:text-purple-400 group-hover:translate-x-1 transition-all" />
                  </div>
                </a>
                ...
                >
                  <div className="flex items-center gap-5">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-lg font-semibold text-white group-hover:text-pink-300 transition-colors">
                        {personalInfo.phone}
                      </p>
                    </div>
                ...
                <div className="contact-card-enhanced p-6">
                  <div className="flex items-center gap-5">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-green-500/15 to-emerald-500/15 flex items-center justify-center border border-green-500/20">
              ...
              {/* 右侧信息卡片 */}
              <motion.div
                className="glass-card-premium p-8 h-fit card-glow-hover"
                initial={{ opacity: 0, x: 40 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
              ...
              >
                <div className="text-center mb-8">
                  <motion.div 
                    className="w-24 h-24 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center mx-auto mb-5 shadow-lg shadow-purple-500/30"
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/10 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-white font-medium">深圳 / 宁夏</p>
                  </div>
                </div>

                {/* 状态 */}
                <div className="flex items-center gap-4 p-4 rounded-xl bg-green-500/10 border border-green-500/20 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-white font-medium">正在寻找 游戏策划 / 内容运营 机会</p>
                  </div>
                </div>
